...
module EX_Forwarding_unit(
	...
	else if (mem_wb_reg_write==1'b1 && mem_wb_write_reg_addr != 5'b00000 && mem_wb_write_reg_addr == id_ex_instr_rs)
	begin
	Forward_A = 2'b01;
	end
	else
	...
	else if (mem_wb_reg_write==1'b1 && mem_wb_write_reg_addr != 5'b00000 && mem_wb_write_reg_addr == id_ex_instr_rt)
	begin
	Forward_B = 2'b01;
    end 
    else
